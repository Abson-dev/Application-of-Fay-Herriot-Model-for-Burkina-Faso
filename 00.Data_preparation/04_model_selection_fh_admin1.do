...
use "$data\region_survey_ehcvm_bfa_2021.dta", clear //region_survey_ehcvm_bfa_2021
...
*=============================================================================== 	
	...
	graph export "$figs\Fig1_left_admin1.png", as(png) replace
	qnorm u_d, `graphs'
	graph export "$figs\u_d_admin1.png", as(png) replace
	...
	graph export "$figs\Fig1_right_admin1.png", as(png) replace
	qnorm e_d, `graphs'
	graph export "$figs\e_d_admin1.png", as(png) replace
/*		
...
save "$data\direct_and_fh_region.dta", replace //direct_and_fh_region