...
use "$data\ehcvm_welfare_2b_bfa2021.dta",clear
...
use "$data\ehcvm_menage_bfa2021.dta",clear
...
use "$data\ehcvm_individu_bfa2021.dta",clear
...
// Merge with HDX Data
*===============================================================================
use "$data\BFA_HDX_ADM3_EHCVM_Matching.dta", clear 

merge m:1 hhid using "$data\survey_ehcvm_bfa_2021.dta"
/*
...
save "$data\commune_survey_ehcvm_bfa_2021_missingHHID.dta" ,replace 
...
append using "$data\commune_survey_ehcvm_bfa_2021_missingHHID.dta"
