...
import delimited "$data\Geospatial Data\geo_indices_Stats_admin_3.csv",clear //geo_indices_Stats_admin_3
...
save "$data\spatial_data_admin3.dta", replace
...
merge 1:1 adm3_pcode using "$data\spatial_data_admin3.dta" 
drop _merge
order adm3_pcode
save "$data\spatial_data_admin3.dta", replace 
...
*===============================================================================
import delimited "$data\Geospatial Data\Healthcare_Stats_admin_3.csv",clear
merge 1:1 adm3_pcode using "$data\spatial_data_admin3.dta" 
drop _merge
order adm3_pcode
save "$data\spatial_data_admin3.dta", replace 
...
*===============================================================================
import delimited "$data\Geospatial Data\Nighttime_Stats_admin_3.csv",clear
...
import delimited "$data\Geospatial Data\Malaria_Stats_admin_3.csv",clear
merge 1:1 adm3_pcode using "$data\spatial_data_admin3.dta" 
drop _merge
order adm3_pcode
save "$data\spatial_data_admin3.dta", replace 
...
*===============================================================================
import delimited "$data\Geospatial Data\Buildings_Stats_admin_3.csv",clear
