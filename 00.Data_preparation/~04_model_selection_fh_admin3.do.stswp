...
*=============================================================================== 	
	...
	graph export "$figs\Fig1_left_admin3.png", as(png) replace
	qnorm u_d, `graphs'
	graph export "$figs\u_d_admin3.png", as(png) replace
	...
	graph export "$figs\Fig1_right_admin3.png", as(png) replace
	qnorm e_d, `graphs'
	graph export "$figs\e_d_admin3.png", as(png) replace
/*		
